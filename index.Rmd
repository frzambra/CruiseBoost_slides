...
```{r, 'silvatierra_landsat', echo=FALSE, warning=FALSE,cache=FALSE,results='asis'}
cat('<iframe src="https://landsat.gsfc.nasa.gov/silviaterra-landsat-use-by-a-forestry-start-up/" width=1000 height=200 allowtransparency="true"> </iframe>')
```
...
cat('<iframe src="./assets/widgets/chilean_forest.html" width=100% height=100% allowtransparency="true"> </iframe>')
```
